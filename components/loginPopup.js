...
const LoginPopup = ({ showPopup, handleLogin, handleCancel }) => {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center z-50">
      ...
      {/* Popup content */}
      <div className="relative bg-white rounded-xl shadow-xl w-full max-w-md m-4 transform transition-all animate-in fade-in slide-in-from-bottom-4">
        {/* Close button */}
        <button 
        ...
        <div className="p-8">
          ...
          <p className="text-gray-600 mb-8">
            Sign in to join the room and connect with others
          </p>
